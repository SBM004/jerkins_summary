...
export default function PackagePage() {
  ...
  return (
    <div className="absolute main overflow-y-auto flex flex-col bg-white max-h-[85vh] m-5 mx-10 mb-10">
      {/* <ul>
        ...
        {search === "" && showdata ? (
          showdata.map((items, index) => (
            ...
            >
              ...
              <div className="cursor-pointer w-[18%]" onClick={()=>{setSelect(items)}}>{items.packageName}</div>
              ...
              <div className="w-[5%] text-[2vh] leading-tight overflow-hidden">{items.imageSize}</div>
              <div className="  break-word overflow-y-auto w w-[40%]  my-2  h-full text-[1.5vh] font-bold leading-tight">{items.comment==="" ||  null?"No Comment ":items.comment}</div>
            </div>
          ))
